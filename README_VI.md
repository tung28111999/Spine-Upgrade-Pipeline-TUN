...
- Atlas xuất ra sử dụng premultiplied alpha. Nếu Unity đang dùng Linear Color Space, hãy dùng đúng workflow texture/material PMA của Spine, nếu không màu có thể bị nhạt.
